...
petik = '```'
fake = '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Kira - Master'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Kira - Master","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `© Kira - Master`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Kira - Master", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "Kira - Master","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Sewa bot?* Chat wa.me/6282322153431`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Kira-Master', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Kira - Master ' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Kira - Master`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://i.ibb.co/wgk4m6S/faa4be33458d.jpg'
              teksnya = `*[ PRICE LIST ]*
*Sewa Bot Kira - Master ON 24 Jam*
*1 Hari :* 2K
*1 Minggu :* 10K
*1 Bulan :* 20K
...
*Chat Owner :* wa.me/6282322153431`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/wgk4m6S/faa4be33458d.jpg'
...
*Minat Join? Chat* wa.me/6282322153431
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt Kira - Master\n Helpme tu 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI Kira - Master\`\`\`')
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`Kira - Master ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
"groupName": `Kira - Master ~ 404 ${vipi}`,
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Subcribe YT Owner :*\n https://facebook.com/fauzixliljee`)
              break
       case 'masukandata':
...
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran Kyura BOTZ 」*\n© Kira - Master\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Kira - Master',
			"buttons": [
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/kii1raaa_`)
             break
      case 'grupbot':
             reply('https://chat.whatsapp.com/KRUXS23p3ZtLD6MYvQfoiF')
             break
      case 'ownermenu':
